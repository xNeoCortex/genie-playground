...
/**
 * Trie un tableau de nombres avec l'algorithme de tri par insertion.
 * Retourne un nouveau tableau et ne modifie pas l'entrée originale.
...
/**
 * Trie un tableau d'entiers non négatifs avec l'algorithme de tri radix (par base).
