...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri shaker (tri à bulles bidirectionnel).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
export function bucketSort(arr: number[]): number[] {
    ...
    for (let num of result) {
        // Normalise num dans l'intervalle [0,1), en synchronisant avec n compartiments
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri pigeonnier (pigeonhole sort).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * Uniquement approprié pour les petits intervalles d'entiers.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri pairs-impairs (odd-even sort, brick sort).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri bitonique.
 * Retourne un nouveau tableau (non en place). Utile pour les tableaux dont la longueur est une puissance de deux.
 * @param arr Tableau de nombres à trier
 */
export function bitonicSort(arr: number[]): number[] {
    ...
    // Copier et remplir le tableau pour atteindre la prochaine puissance de deux
    let result = [...arr];
    let n = result.length;
    let powerOfTwo = 1;
    while (powerOfTwo < n) {
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri fusion (merge sort).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri par sélection (selection sort).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri à bulles (bubble sort).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri rapide (quick sort).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri par tas (heap sort).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres à l'aide de l'algorithme de tri Shell (shell sort).
 * Retourne un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
