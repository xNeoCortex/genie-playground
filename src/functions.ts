...
/**
 * Trie un tableau d'entiers non négatifs en utilisant l'algorithme de tri radix (par base).
 * Ne modifie pas l'entrée originale. Fonctionne uniquement pour les entiers non négatifs.
