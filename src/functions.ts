...
/**
 * Trie un tableau de nombres en utilisant l'algorithme de tri shaker cocktail (bubble sort bidirectionnel).
 * Renvoie un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres en utilisant l'algorithme de tri du gnome.
 * Renvoie un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres en utilisant l'algorithme de tri peigne (comb sort).
 * Renvoie un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres en utilisant l'algorithme de tri par paniers (bucket sort).
 * Renvoie un nouveau tableau et ne modifie pas l'entrée.
 * Pour simplifier, fonctionne mieux pour des données réparties uniformément dans l'intervalle [0, 1).
 * @param arr Tableau de nombres à trier
 */
 ...
 * Renvoie un nouveau tableau et ne modifie pas l'entrée.
 * Convient uniquement pour des plages d'entiers petites.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres en utilisant l'algorithme de tri impair-pair (brick sort).
 * Renvoie un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
 ...
 * Renvoie un nouveau tableau (pas en place). Utile pour des tableaux de longueur puissance de deux.
 * @param arr Tableau de nombres à trier
 */
export function bitonicSort(arr: number[]): number[] {
    ...
    // Copier et compléter le tableau jusqu'à la prochaine puissance de deux
    let result = [...arr];
    let n = result.length;
    let powerOfTwo = 1;
    while (powerOfTwo < n) {
...
/**
 * Trie un tableau de nombres en utilisant l'algorithme de tri à bulles (bubble sort).
 * Renvoie un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
...
/**
 * Trie un tableau de nombres en utilisant l'algorithme de tri shell.
 * Renvoie un nouveau tableau et ne modifie pas l'entrée.
 * @param arr Tableau de nombres à trier
 */
