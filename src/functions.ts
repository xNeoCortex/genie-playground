 ...
 * Retourne un nouveau tableau et ne modifie pas l'entrée d'origine.
...
/**
 * Trie un tableau d'entiers non négatifs à l'aide de l'algorithme de tri par comptage ("counting sort").
 * Ne modifie pas l'entrée d'origine. Fonctionne uniquement sur les entiers non négatifs.
...
/**
 * Trie un tableau d'entiers non négatifs à l'aide de l'algorithme de tri par base ("radix sort").
 * Ne modifie pas l'entrée d'origine. Fonctionne uniquement sur les entiers non négatifs.
 * @param arr Tableau d'entiers non négatifs à trier
 */
