 ...
 * Ne modifie pas l'entrée d'origine. Fonctionne uniquement pour les entiers non négatifs.
...
/**
 * Trie un tableau d'entiers non négatifs à l'aide de l'algorithme de tri radix (radix sort).
 * Ne modifie pas l'entrée d'origine. Fonctionne uniquement pour les entiers non négatifs.
 * @param arr Tableau d'entiers non négatifs à trier
 */
